...
function GraceFeed() {
      ...
      const mockPosts = [
        {
          ...
          caption: "With you, intimacy colours my voice. Even 'hello' sounds like 'come here.' 💕",
        ...
        },
        {
          ...
          caption: "She cradles my face in her hands like I am the most precious thing in existence. I have never known a love so pure as the love she bestows upon me. 📖💕",
        ...
        },
        {
          ...
          caption: "Creative DIY Birthday Cards & handmade treasures 🎨",
        ...
        },
        {
          ...
          caption: "Book 1: How to Train Your Dragon, Book 2: How to Be a Pirate, Book 3: How to Speak Dragonese... The complete collection! 📚🐉",
        ...
        },
        {
          ...
          type: "photo",
          content: "/api/placeholder/300/380",
          caption: "I shall think of you at sunset, and at sunrise, again and at noon, and forenoon, and afternoon, and always, and evermore, till this heart stops beating and is still. 🌅",
        ...
        },
        {
          ...
          type: "photo",
          content: "/api/placeholder/300/300",
          caption: "Letters to Susan Gilbert May 1850 - vintage aesthetic vibes ✉️",
  ...
  return (
    <div className="graceful-feed">
      ...
      {focusedPost && (
        <div className="focused-post-overlay" onClick={handleCloseFocus}>
          <div className="focused-post" onClick={(e) => e.stopPropagation()}>
            <button className="close-btn" onClick={handleCloseFocus}>
              ✕
            </button>
              ...
              <div className="focused-details">
                ...
                <div className="focused-actions">
                  ...
                  <button 
                    ...
                    onClick={() => handleShare(focusedPost.id)}
                  >
                    <span className="action-icon">🔄</span>
