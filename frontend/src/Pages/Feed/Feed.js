...
function Feed() {
    ...
    const fetchPosts = async () => {
        ...
        try {
            ...
            console.error(
                "Error fetching posts from API, using mock data:",
                error
            );
        ...
        try {
            ...
            if (isAuthenticated && user) {
                try {
                    ...
                    console.warn(
                        "API save failed, but like updated locally:",
                        apiError
                    );
                }
            }
        ...
        try {
            ...
            if (isAuthenticated && user) {
                try {
                    ...
                    console.warn(
                        "API save failed, but share updated locally:",
                        apiError
                    );
                }
            }
                    ...
                    if (post.id === postId || post._id === postId) {
                        return {
                            ...
                            shares: post.shares.filter(
                                (share) => share.user !== currentUser._id
                            ),
                        };
                    }
                    return post;
    ...
    const handlePostSubmit = async () => {
        ...
        try {
            ...
            const localPost = {
                ...
                type: newPost.type,
                content:
                    newPost.preview || "https://via.placeholder.com/300x400",
                caption: newPost.caption,
                timestamp: new Date(),
                createdAt: new Date(),
                likes: [],
            ...
            if (isAuthenticated && user && newPost.file) {
                ...
                try {
                    ...
                    console.warn(
                        "API save failed, but post created locally:",
                        apiError
                    );
                }
            }
