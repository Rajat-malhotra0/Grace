      ...
      <div className="volunteer-board">
        {opportunityForms.map((form, index) => (
          <div className="volunteer-column" key={index}>
            <div className="opportunity-header">
              ...
              <h3 className="opportunity-title">Opportunity {index + 1}</h3>
            </div>
        ...
        <div className="volunteer-column add-column">
          <div className="add-column-content">
            ...
            <p className="add-subtitle">Create another volunteer opportunity</p>
            <button className="add-btn" onClick={addOpportunityColumn}>
              <Plus size={20} />
              Add Opportunity
            </button>
          </div>
