...
const ngoCompleteData = [
  {
    ...
    mission: "Providing gentle spaces for children to learn, dream, and heal",
  ...
  },
  {
    ...
    name: "EarthNest",
    quote: "In every growing tree, a  promise",
    description:
  ...
  },
  {
    ...
    heroVideoPath: null,
    coverImagePath: "ngo4.jpg", // Women empowerment theme
    aboutUs: {
      description:
    ...
    mission: "Empowering women to create positive change in their communities",
    volunteersNeeded: 80,
    donationGoal: 30000,
  ...
  },
  {
    ...
    mission: "Bridging educational gaps through innovative learning programs",
    volunteersNeeded: 90,
    donationGoal: 28000,
  ...
  try {
    ...
    for (const ngoData of ngoCompleteData) {
      ...
      if (ngoData.heroVideoPath) {
        heroVideoUrl = await uploadVideoToCloudinary(ngoData.heroVideoPath);
      }

      // Upload cover image
      const coverImage = await uploadImageToCloudinary(ngoData.coverImagePath);
      ...
      for (const project of ngoData.projects) {
        const projectImage = await uploadImageToCloudinary(project.imagePath);
        projects.push({
          id: project.id,
          title: project.title,
      ...
      for (const option of ngoData.donate.options) {
        const optionImage = await uploadImageToCloudinary(option.imagePath);
        donateOptions.push({
          id: option.id,
          title: option.title,
